...
public class CreateTrip extends AppCompatActivity {
    ...
    public void initUiElements(){
        ...
        adapter = new CreatedAdapter(this,tripList,Keys);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(UserEnteredID.equals("")){
                    Toast.makeText(CreateTrip.this,"Enter a Valid unique id to sync",Toast.LENGTH_SHORT).show();
                    return;
                }
                else
                {
                    Intent intent = new Intent(CreateTrip.this,CreateNewTripDetailed.class);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(CreateTrip.this,LoginActivity.class);
                    startActivity(intent);
                }
            }
        };
