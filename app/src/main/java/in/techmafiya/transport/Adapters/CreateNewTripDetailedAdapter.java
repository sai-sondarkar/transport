...
public class CreateNewTripDetailedAdapter extends ArrayAdapter<SingleLocalityDetails> {
    ...
    public CreateNewTripDetailedAdapter.ViewHolder holder;
    public CreateNewTripDetailedAdapter(Activity activity,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder = new CreateNewTripDetailedAdapter.ViewHolder();
            ...
            holder = (CreateNewTripDetailedAdapter.ViewHolder) view.getTag();
        }
